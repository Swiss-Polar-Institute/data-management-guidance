...
\fancyhead[L]{\includegraphics[scale=0.7]{spi_logo.png}}
\fancyfoot[L]{\date{$date$}}
\fancyfoot[C]{\thepage}
...
\fancypagestyle{plain}{%
  \fancyhead[L]{\includegraphics[scale=0.7]{spi_logo.png}} % add SPI logo
  \fancyfoot[C]{\thepage} % add centred page number
  \fancyfoot[L]{\date{$date$}}
  \setlength{\headheight}{20pt} % set height of header so it is not affected by header on title page
  \setlength{\footskip}{0pt} % set height of footer so it is not affected by header on title page
}

\fancypagestyle{titlepagestyle}
{
  \fancyhead[L]{\includegraphics[scale=1]{spi_logo.png}\\ \hrulefill \\ EPFL ENT SPI \\ GR C2 505 \\ Station 2 \\ CH-1015 Lausanne, Switzerland}
