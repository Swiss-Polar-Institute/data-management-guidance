...
\usepackage{graphicx}
\usepackage{etoolbox} % added this to make the footer height the same on all pages
\patchcmd{\chapter}{\thispagestyle{plain}}{\thispagestyle{fancy}}{}{} % added this to make the footer height the same on all pages
...
\fancypagestyle{plain}{%  first page of chapters
  ...
  \setlength{\headsep}{20pt}
  \setlength{\headheight}{21pt} % set height of header so it is not affected by header on title page
  \setlength{\footskip}{12pt} % set height of footer so it is not affected by header on title page
}
